...
(ert-deftest test-terraform-mode--assignment ()
  (dolist (case '(((description . "assignment target")
                  ...
                  ((description . "first key in inline map gets variable-name face")
                   (content     . "foo = {test = \"bar\", baz = 123}")
                   (check       . (((pos . 8) (face . font-lock-variable-name-face)))))
                  ((description . "second key in inline map gets variable-name face")
                   (content     . "foo = {test = \"bar\", baz = 123}")
                   (check       . (((pos . 22) (face . font-lock-variable-name-face)))))))
    (terraform-test-face (alist-get 'description case)
                         (alist-get 'content case)
                         (alist-get 'check case))))
...
(ert-deftest test-terraform-mode--literal-keywords ()
  (dolist (case '(((description . "true gets constant face globally")
                   (content     . "true")
                   (check       . (((pos . 1) (face . font-lock-constant-face)))))
                  ((description . "false gets constant face globally")
                   (content     . "false")
                   (check       . (((pos . 1) (face . font-lock-constant-face)))))
                  ...
                  ((description . "false inside resource block gets constant face")
                   ...
                   (check       . (((pos . 57) (face . font-lock-constant-face)))))
                  ((description . "null gets constant face")
                   (content     . "null")
                   (check       . (((pos . 1) (face . font-lock-constant-face)))))))
    (terraform-test-face (alist-get 'description case)
                         (alist-get 'content case)
...
(ert-deftest test-terraform-mode--negation ()
  (dolist (case '(((description . "! before word gets builtin face")
                   (content     . "!var.enabled")
                   (check       . (((pos . 1) (face . font-lock-builtin-face)))))
                  ((description . "! before paren gets builtin face")
                   (content     . "!(a || b)")
                   (check       . (((pos . 1) (face . font-lock-builtin-face)))))
                  ((description . "! in != does not get builtin face")
                   (content     . "a != b")
                   (check       . (((pos . 3) (face . nil)))))
